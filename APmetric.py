...
"""
# contmtx is a 2-dimensional real-valued contingency matrix whose rows are
# truth values and whose columns are cluster numbers
# The funcation calculates the associativity-peakiness (AP) metric for this
# contingency matrix.
...
def calcAPmetric(contmtx):
    ...
    # AP metric is harmonic mean of peakines and associativity metrics
